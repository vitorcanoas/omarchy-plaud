...
Built by a Plaud user to help the Arch Linux / Omarchy community, without
claiming ownership of Plaud's technology or competing with its official apps.
This project is not affiliated with or endorsed by Plaud or Omarchy. Respect
Plaud's copyrights and trademarks; do not sell Plaud-owned materials or present
this client as an official product. **Prefer the official Plaud app whenever
it supports your system.** See [project purpose and third-party rights](docs/PROJECT_NOTICE.md).
